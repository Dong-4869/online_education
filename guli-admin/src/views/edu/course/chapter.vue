  ...
  <div class="app-container">
    ...
    <el-dialog :visible.sync="dialogChapterFormVisible" title="添加章节">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="cannelSaveOrUpdateChapter">取 消</el-button>
    ...
    <el-dialog :visible.sync="dialogVideoFormVisible" title="添加课时">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="cannelSaveOrUpdateVideo">取 消</el-button>
        <el-button
    ...
    <ul class="chanpterList">
      <li v-for="chapter in chapterNestedList" :key="chapter.id">
        <p>
          {{ chapter.title }}
          <span class="acts">
            <el-button type="text" @click="addVideoBefore(chapter.id)"
              >添加课时</el-button
            >
    ...
    editVideo(videoId) {
      ...
      video.getVideoInfoById(videoId).then((response) => {
        ...
        if (this.video.videoOriginalName != "") {
          this.video.fileList = [{ name: this.video.videoOriginalName }];
        }
      });
    },
