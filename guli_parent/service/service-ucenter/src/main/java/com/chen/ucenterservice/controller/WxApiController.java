...
import com.chen.ucenterservice.util.ConstantPropertiesUtil;
import com.chen.ucenterservice.util.HttpClientUtils;
...
public class WxApiController {
    ...
    public String genQrConnect(HttpSession session) {
        ...
        String state = "chen";//为了让大家能够使用我搭建的外网的微信回调跳转服务器，这里填写你在ngrok的前置域名
        System.out.println("state = " + state);
